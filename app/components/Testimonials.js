export default function Testimonials() {
    return (
      <section id="testimonials" className="px-4 md:px-12 lg:px-32 py-20 border-t border-[#1a1a1a]">
        <div className="max-w-3xl mx-auto">
          <p className="text-[#00ff9d] text-xs md:text-sm mb-4">{'>'} testimonials.fetch()</p>
